...
# PHOTOMETRY_APERTURE = 2.25  # pixels; stellar flux aperture (Lewis: 2.25 for 4.5 μm)
...
#         # Find only BCD files (not unc2d or sub2d)
...
#                 # BJD_TDB = BMJD + 2400000.5 + UTC→TDB correction (~66s or 0.00076 days)
...
#     # ============================================================
#     # Primary campaign: BJD 24555751-24555757 (~144 hr, matches your diagnostic)
#     print("\n" + "=" * 60)
